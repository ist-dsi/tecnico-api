...
public class ExecutionCourseSerializer extends DomainObjectSerializer {
    ...
    protected ExecutionCourseSerializer(FenixEduAPISerializer apiSerializer) {
        super(apiSerializer);
    }
    ...
    public @NotNull JsonObject serializeExtended(@NotNull ExecutionCourse executionCourse) {
        ...
        courseInformation.addProperty("enrolledStudents", executionCourse.getTotalEnrolmentStudentNumber());
