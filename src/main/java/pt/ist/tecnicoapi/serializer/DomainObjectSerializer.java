...
public abstract class DomainObjectSerializer {
    ...
    private final @NotNull TecnicoAPISerializer apiSerializer;

    protected DomainObjectSerializer(@NotNull TecnicoAPISerializer apiSerializer) {
        this.apiSerializer = apiSerializer;
    }

    protected @NotNull TecnicoAPISerializer getAPISerializer() {
